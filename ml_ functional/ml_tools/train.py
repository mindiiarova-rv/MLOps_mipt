...
from utils.dataframe_create import create_dataframe 
...
class Trainer:
    def __init__(self, cfg):
        ...
        self.model = create_model(model_name="resnet1d18", config=cfg)
        self.criterion = None
    ...
    def get_dataset_loader(
        ...
        ecg_dataset = EcgDataset.for_train_from_config(
            df, df.target.values, augmentation, cfg, classes_num
        )
